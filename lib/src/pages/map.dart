...
import 'package:markets_deliveryboy/src/helpers/maps_util.dart';
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () {
              ...
              MapsUtil.openMap(_con.currentOrder?.deliveryAddress?.latitude, _con.currentOrder?.deliveryAddress?.longitude);
            },
          ),
        ],
      ),
